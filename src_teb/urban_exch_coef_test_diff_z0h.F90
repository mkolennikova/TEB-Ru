...
!REAL, DIMENSION(:), INTENT(OUT)   :: ZZ0H     ! roughness length for heat
...
!
  CALL SURFACE_CD(PRI, PZREF, PUREF, PZ0, PZ0H, PCD, PCDN)
!
  CALL SURFACE_AERO_COND(PRI, PZREF, PUREF, PVMOD, PZ0, PZ0H, PAC, PRA, PCH)
!
!
