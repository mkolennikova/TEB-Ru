...
!     #########
    SUBROUTINE TEB_GARDEN_STRUCT (icell, iblock, OGARDEN, OGARDEN_EXT, OGREENROOF, OGREENROOF_EXT, OSOLAR_PANEL,          &
                     ...
                     PSO_ALB_TOWN, ZSW_UP_SO, PRESA_TOWN, PDQS_TOWN, PQF_TOWN, PQF_BLD,  &
                     PFLX_BLD, PAC_ROOF, PAC_ROAD, PAC_WALL, PAC_GARDEN, PAC_GREENROOF,           &
...
REAL, DIMENSION(:)  , INTENT(IN)    :: PALB_GD_EXT        ! garden albedo
REAL, DIMENSION(:)  , INTENT(IN)    :: PEMIS_GD_EXT       ! garden emissivity 
REAL, DIMENSION(:)  , INTENT(IN)    :: PTSRAD_GD_EXT      ! garden radiative surface temp. (snow free) 
REAL, DIMENSION(:)  , INTENT(IN)    :: PQV_GD_EXT         ! garden specific humidity
REAL, DIMENSION(:)  , INTENT(IN)    :: PH_GD_EXT          ! sensible heat flux over garden 
...
REAL, DIMENSION(:)  , INTENT(OUT)   :: PSO_ALB_TOWN       ! town equivalent solar albedo
...
PSO_ALB_TOWN     = XUNDEF  ! town equivalent solar albedo
...
PAC_ROOF         = XUNDEF  ! roof conductance
...
CALL TEB_GARDEN           (icell, iblock, TOP, T, BOP, B, TPN, TIR, DMT, OGARDEN_EXT, OGREENROOF_EXT,               &
                           ...
                           PDIR_ALB_TOWN, PSCA_ALB_TOWN, PSO_ALB_TOWN, ZSW_UP_SO, PRESA_TOWN, PAC_ROOF, PAC_ROAD, PAC_WALL, &
						   PAC_GARDEN,           &
						   ...
						   PCH_WL, PCH_TOP, PAC_TOP, ILMO_ROAD, ILMO_ROOF, ILMO_TOP, PCD_TERRA, PCH_TERRA)
!
!-------------------------------------------------------------------------------
!
